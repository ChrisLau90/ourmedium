...
{
    register_taxonomy_for_object_type('category', 'ourmedium'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'ourmedium');
    register_post_type('ourmedium', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Our Medium Custom Post', 'ourmedium'), // Rename these to suit
            'singular_name' => __('Our Medium Custom Post', 'ourmedium'),
            'add_new' => __('Add New', 'ourmedium'),
            'add_new_item' => __('Add New Our Medium Custom Post', 'ourmedium'),
            'edit' => __('Edit', 'ourmedium'),
            'edit_item' => __('Edit Our Medium Custom Post', 'ourmedium'),
            'new_item' => __('New Our Medium Custom Post', 'ourmedium'),
            'view' => __('View Our Medium Custom Post', 'ourmedium'),
            'view_item' => __('View Our Medium Custom Post', 'ourmedium'),
            'search_items' => __('Search Our Medium Custom Post', 'ourmedium'),
            'not_found' => __('No Our Medium Custom Posts found', 'ourmedium'),
            'not_found_in_trash' => __('No Our Medium Custom Posts found in Trash', 'ourmedium')
        ),
        'public' => true,
